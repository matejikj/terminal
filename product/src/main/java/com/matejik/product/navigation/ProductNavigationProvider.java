...
public class ProductNavigationProvider implements TerminalNavigationProvider {
    ...
    public List<TerminalNavItem> items() {
        return List.of(
                new TerminalNavItem("terminal.menu.phone", VaadinIcon.PHONE::create, ProductPhoneGridRoute.class),
                new TerminalNavItem("terminal.menu.contacts", VaadinIcon.GROUP::create, ProductContactsRoute.class),
                new TerminalNavItem("terminal.menu.settings", VaadinIcon.COG::create, ProductSettingsRoute.class)
        );
    }
}
