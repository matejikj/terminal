...
public class SettingsView extends Composite<Div> {
    ...
    public SettingsView(TerminalLocaleService localeService, SipTerminalService sipService) {
        ...
        var root = getContent();
        root.addClassNames(LumoUtility.Display.FLEX, LumoUtility.FlexDirection.COLUMN, LumoUtility.Gap.LARGE,
    ...
    private Div buildLocalizationCard() {
        var card = new Div();
        card.addClassNames("settings-card", LumoUtility.Padding.MEDIUM, LumoUtility.BorderRadius.MEDIUM,
    ...
    private Div buildSipCard() {
        var card = new Div();
        card.addClassNames("settings-card", LumoUtility.Padding.MEDIUM, LumoUtility.BorderRadius.MEDIUM,
                LumoUtility.BoxShadow.SMALL, LumoUtility.Display.FLEX, LumoUtility.FlexDirection.COLUMN,
        ...
        var connectButton = new Button(getTranslation("terminal.settings.connect"), event -> {
            var credentials = new SipAccountCredentials(
        ...
        var disconnectButton = new Button(getTranslation("terminal.settings.disconnect"), event -> sipService.disconnect());
